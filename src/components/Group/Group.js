...
const groupscript = {
  0: "* 신장기능이 평균이지만, 유병기간이 긴 그룹",
  1: "* 신장기능이 평균이지만, 유병기간이 긴 그룹",
  2: "* 신장기능이 평균이지만, 유병기간이 긴 그룹",
  3: "* 신장기능이 평균이지만, 유병기간이 긴 그룹",
  4: "* 신장기능이 평균이지만, 유병기간이 긴 그룹",
  5: "* 신장기능이 평균이지만, 유병기간이 긴 그룹",
  6: "* 신장기능이 평균이지만, 유병기간이 긴 그룹"
};
...
class Group extends Component {
  ...
  render() {
    ...
    const { dimensions, group, person } = this.state;
    return (
