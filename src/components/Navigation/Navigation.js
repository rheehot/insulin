    ...
    return (
        <div className={"nav"}>
            ...
            <div className={"dept"}>
                ...
                <Select defaultValue="내분비과" style={{ width:120 }} onChange={handleChange}>
            ...
            <div className={"docname"}>
                ...
                <Select defaultValue="김철수" style={{ width: 90 }} onChange={handleChange}>
                <Option value="1">김철수</Option>
                <Option value="2">김철수</Option>
                </Select>
                <Select defaultValue="박영희" style={{ width: 90 }} onChange={handleChange}>
            ...
            <Select defaultValue="2018.09.19 -" style={{ width: 150 }} onChange={handleChange}>
            ...
            <Select defaultValue="2018.09.19 - 재원중" style={{ width: 180 }} onChange={handleChange}>
